const turnosQueries = {
  ...
  getAllTurnosLibresPorDia:'select count(*) as total from t_calendario_dia tcd join t_disciplina td on tcd.disciplinaId = td.disciplinaId where tcd.fechaCalendario like ? and tcd.turno_andarivel1 is null and td.horarioDeInicioDisciplina = 8;',
